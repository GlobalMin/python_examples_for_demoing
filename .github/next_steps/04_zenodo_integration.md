...
2. Your package will get a DOI only after you make a release. Create a new release as described in [README.dev.md](git@github.com:<my-github-organization>/python_examples_for_demoing/blob/main/README.dev.md#33-github)
